...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x10154b6e;
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 6;
...
For example:
GucciCoind --print-genesis-tx --genesis-block-reward-address TRTLv2Fyavy8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyoBh4wW
...
/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in GucciCoind. It is used to know what timestamp
...
/* The mixin to use by default with zedwallet and gucci-service */
...
const char     CRYPTONOTE_NAME[]                             = "GucciCoin";
...
const int      P2P_DEFAULT_PORT                              =  10171;
const int      RPC_DEFAULT_PORT                              =  10181;
...
const char     LATEST_VERSION_URL[]                          = "https://guccicoin.cf";
const std::string LICENSE_URL                                = "https://github.com/guccicoin-project/guccicoin/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x38, 0x9e, 0x0c, 0x82, 0x40, 0x96, 0x57, 0x53, 0x52, 0x3c, 0xdf, 0x4f, 0x57, 0x34, 0xc6, 0xd2  }
};

const char* const SEED_NODES[] = {
  "195.201.145.173:10171",
  "195.201.145.173:10172"
};
} // CryptoNote
